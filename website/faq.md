...
To find out about JuliaMono's Unicode support, you could look at the Glyphs page on this site, or you could visit [glyphy.info](https://glyphy.info) and type a name (e.g. `interrobang`) or a hexadecimal number (e.g. `0x203d`), If the glyph is present in JuliaMono, you'll see a checkmark `✓`:
...
The font is OFL/SIL-licensed, and you can find the source [here](https://github.com/cormullion/juliamonomaster). The SIL license allows you to do almost anything you want, **except** re-issue it under the same name or with a different license.
...
Unicode allows you to combine characters - i.e. stack them vertically. For example, you can combine the glyph for `e` (U+0065) with the glyph U+20D7 (the “combining right arrow above”) to get:
...
and the arrow mark is displayed above the character. There are lots of these **combining marks** (also **diacritics**) in Unicode (e.g. U+0300 to U+036F, U+20D0 to U+20F0, and others).
...
d̢̳̪̺̯͍̐ͮ̄̅ͤͬ͊̓͒̄́̀͠i̜̪͔͇̖͙͈͍̓̇̽͊͗a̢̧̝̳̻̣̫͖̹̟̬̲ͥͤͯ͑͐c͖̯̤ͨͩ͐ͣ̔͛︢͐͐͞ř̙ͮ͐̽ͨ͒i̧̡͙̳̫̦̫͓̱̜̜̼ͫ̆͢t̡̧̨̝̱̘̜ͥ̔̂ͮ̏ͤ︢͛ͭͪ̑̑͟͝͝ḭ̭̲̭̥͓̳͔̩̖̤̄̍̆͋́̎︢ͦ̽͘͜͟͟c̡̯͉̗ͮ̌̀͘͡͞͠"
